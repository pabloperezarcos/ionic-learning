...
export class SlidesPage implements OnInit {
  ...
  //no olvidar inyectar los servicios para poder utilizarlos
  //en este caso usamos NavController el cual fue inyectado
  //a través del constructor para poder usarlo en "onClick()"
  onClick(){
